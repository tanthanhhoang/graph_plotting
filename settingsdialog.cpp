    ...
    ui(new Ui::SettingsDialog)
{
    ...
    connect(ui->languageCheckBox, SIGNAL(clicked()),
...
void SettingsDialog::changeLanguage(){
    if(ui->languageCheckBox->isChecked()==true){
        this->setWindowTitle("Settings");
        ui->refreshButton->setText("Refresh");
        ui->applyButton->setText("Apply");
        ui->additionalOptionsGroupBox->setTitle("Language");
        ui->selectBox->setTitle("Select Serial Port");
        ui->parametersBox->setTitle("Select Parameters");
        ui->descriptionLabel->setText("Description: ");
        ui->manufacturerLabel->setText("Manufacturer: ");
        ui->serialNumberLabel->setText("Serial number: ");
        ui->locationLabel->setText("Location: ");
    }
    else{
        this->setWindowTitle("Cài đặt");
        ui->refreshButton->setText("Làm tươi");
        ui->applyButton->setText("Áp dụng");
        ui->additionalOptionsGroupBox->setTitle("Ngôn ngữ");
        ui->selectBox->setTitle("Chọn cổng COM");
        ui->parametersBox->setTitle("Chọn hệ số");
        ui->descriptionLabel->setText("Mô tả: ");
        ui->manufacturerLabel->setText("Nhà sản xuất: ");
        ui->serialNumberLabel->setText("Số seri: ");
        ui->locationLabel->setText("Địa điểm: ");
    }
}
void SettingsDialog::showPortInfo(int idx)
{
    if (idx != -1) {
        ...
        if(ui->languageCheckBox->isChecked()==true){
            ...
            ui->descriptionLabel->setText(tr("Mô tả: %1").arg(list.at(1)));
            ui->manufacturerLabel->setText(tr("Nhà sản xuất: %1").arg(list.at(2)));
            ui->serialNumberLabel->setText(tr("Số seri: %1").arg(list.at(3)));
            ui->locationLabel->setText(tr("Địa điểm: %1").arg(list.at(4)));
        }
    }
}
...
void SettingsDialog::updateSettings()
{
    ...
    currentSettings.language = ui->languageCheckBox->isChecked();
}
